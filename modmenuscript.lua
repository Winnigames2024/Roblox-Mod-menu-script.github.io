gg.alert('🌐Mod Menu 1.0v by Henry1887🌐')
gg.toast('Subscribe to Bro_Like2000')

::modmenu::
menu=gg.choice({'🚷No-Clip🚷' , '⬆️Infinite Jump⬆️' , '➰Speed Hack➰' , '💵🏦Money Hacks🏦💵' , '🔆Other Game hacks🔆' , '📴TURN OFF HACKS📴'},nil, 'Henry1887 Mod Menu')
